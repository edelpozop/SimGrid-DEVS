...
void test_all(char *file)
{
	...
	p = MSG_process_create_with_arguments(str, toManual, NULL, MSG_get_host_by_name(str), argc, argvc3);
	if(p == NULL)
	{
		printf("Error en ......... %s", str);
		printf("\n");
	...
	p = MSG_process_create_with_arguments(str, manual, NULL, MSG_get_host_by_name(str), argc, argvc4);
	if(p == NULL)
	{
		printf("Error en ......... %s", str);
		printf("\n");
	...
	p = MSG_process_create_with_arguments(str, toAutomatic, NULL, MSG_get_host_by_name(str), argc, argvc5);
	if(p == NULL)
	{
		printf("Error en ......... %s", str);
		printf("\n");
